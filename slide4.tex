...
\begin{document}
  ...
  \begin{frame}
      \frametitle{水位线}
\mybox[5cm]{red!70!black}{水位线定义}{Flink认为小于水位线的事件都已到达}
  \end{frame}

\begin{frame}
	\frametitle{水位线}
	
	\mybox[5cm]{red!70!black}{水位线定义}{水位线是一种逻辑时钟}
	
\end{frame}

\begin{frame}
	\frametitle{水位线}
	\mybox[5cm]{red!70!black}{水位线定义}{水位线由程序员编程插入到数据流中}
\end{frame}

\begin{frame}
	\frametitle{水位线}
	\mybox[5cm]{red!70!black}{水位线定义}{水位线是一种特殊的事件}
\end{frame}

\begin{frame}
	\frametitle{水位线}
	\mybox[5cm]{red!70!black}{水位线定义}{在事件时间的世界里，水位线就是时间}
\end{frame}
  ...
  \begin{frame}
      ...
      \begin{itemize}
          ...
          \item Watermark 必须单调递增，以确保任务的事件时间时钟在向前推进，而不是在后退，（Watermark就是当前数据流的逻辑时钟）
